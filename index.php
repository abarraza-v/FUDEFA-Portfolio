  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between position-relative">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link link-light scrollto active" href="#hero">Inicio</a></li>
          <li><a class="nav-link link-light scrollto" href="#about">Sobre nosotros</a></li>
          <li><a class="nav-link link-light scrollto" href="#services">Servicios</a></li>
          <li><a class="nav-link link-light scrollto" href="#portfolio">Proyectos</a></li>
          <li><a class="nav-link link-light scrollto" href="#team">Equipo</a></li>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-in" data-aos-delay="100">
          <h2>Proyectos</h2>
          <p>Aquí encontrarás una serie de proyectos que hemos terminado exitosamente.</p>
        </div>
